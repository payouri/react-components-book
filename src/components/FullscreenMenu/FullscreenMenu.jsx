  ...
  const handleTransition = (e) => {
    ...
    if (target == wrapperRef.current)
      target.classList.contains(styles["open"])
        ? typeof onMenuOpen == "function" && onMenuOpen(wrapperRef)
        : typeof onMenuClose == "function" && onMenuClose(wrapperRef);
  };

  return (
    <div
      ref={wrapperRef}
      onTransitionEndCapture={handleTransition}
